...
import { getProductsByCategory, getProductsByPurpose, products } from '@/data/products';
  ...
  useEffect(() => {
    ...
    switch (sortOption) {
      ...
      case 'newest':
        ...
        filteredProducts = filteredProducts.filter(p => p.badges?.includes('new')).concat(
          filteredProducts.filter(p => !p.badges?.includes('new'))
        );
        break;
      case 'bestselling':
        filteredProducts = filteredProducts.filter(p => p.badges?.includes('bestseller')).concat(
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow section-padding">
        <div className="container mx-auto">
          <h1 className="text-3xl font-medium text-center mb-2">Shop All Products</h1>
          <p className="text-bloom-gray text-center mb-8">Mindfully created tools for your daily practice.</p>
          ...
          {displayedProducts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-bloom-gray">Try adjusting your filters to find what you're looking for.</p>
            </div>
          )}
        </div>
      </main>
