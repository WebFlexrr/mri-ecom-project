  ...
  return (
    ...
    <div className="max-w-4xl mx-auto my-8 p-6 bg-white shadow-lg rounded-lg flex flex-col md:flex-row items-center bottom-3">
      ...
      <div className="md:w-1/2 p-4">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Bloom & Build</h2>
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-2 mb-6">
          <li>✔ Wiro-Bound Format</li>
          <li>✔ Multiple Colors</li>
          <li>✔ Detailed Daily Planning Sections</li>
          <li>✔ Schedule Important Calls and Meetings</li>
          <li>✔ Prompts for Self Care</li>
        </ul>
